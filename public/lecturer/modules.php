...
if (!$lecturer) {
    ...
    echo '<div class="alert alert-warning small">Your lecturer profile is not set up yet. Ask the Head Of Department or Principal to assign you a department.</div>';
