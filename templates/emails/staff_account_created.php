...
<p>An account has been created for you on the Student Event Management &amp; Announcement System (SEMAS) with the role of <strong><?= htmlspecialchars($role_label) ?></strong>, by <?= htmlspecialchars($created_by_name) ?>.</p>
